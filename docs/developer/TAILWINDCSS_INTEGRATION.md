...
```html
{% extends "templates/web.html" %} {% block title %}{{ _("Page Title") }}{%
...
/>
<div class="text-red-500 text-sm" v-if="hasError">Error message</div>
```
...
<link
  rel="preload"
  href="/assets/verenigingen/css/tailwind.css"
  as="style"
...
<div class="membership-type-card" data-type="regular">
  ...
  <div class="custom-amount-section" style="display: none;">
    ...
    <input
      type="number"
      class="form-input custom-amount-input"
      min="10"
      step="0.01"
...
<div class="input-group" id="bank-details">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
    <div class="input-group">
      <label for="account_holder_name" class="input-label required"
