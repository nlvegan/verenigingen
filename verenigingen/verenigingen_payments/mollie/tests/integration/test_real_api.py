...
from verenigingen.verenigingen_payments.mollie.utils.mollie_relationship_manager import (
...
class TestMollieSubscriptionRealAPI(EnhancedTestCase):
    ...
    def test_real_customer_creation_flow(self):
        ...
        result = self.relationship_manager.create_member_mollie_relationship(
            ...
            mollie_customer.id,
            {"amount": 25.00, "interval": "1 month", "description": "Real API test subscription"},
        )
    ...
    def test_real_first_payment_creation(self):
        ...
        payment_data = {
            ...
            "webhookUrl": "https://dev.veganisme.net/api/method/verenigingen.verenigingen_payments.mollie.utils.mollie_relationship_manager.enhanced_mollie_subscription_webhook",
            "metadata": {
    ...
    def test_real_webhook_processing_simulation(self):
        ...
        webhook_payload = {
            ...
            "payment": {
                ...
                "amount": {"currency": "EUR", "value": "25.00"},
                "method": "directdebit",
                "metadata": {"member_id": self.test_member.name, "agreement_id": agreement.name},
            },
            "metadata": {"member_id": self.test_member.name, "agreement_id": agreement.name},
        }
        ...
        self.assertEqual(result["status"], "success", f"Webhook processing must succeed, got: {result}")
    ...
    def test_real_error_scenarios_and_recovery(self):
        ...
        invalid_webhook_data = {"id": "invalid_subscription_id", "payment": {"id": "invalid_payment_id"}}
    ...
    def test_end_to_end_subscription_flow(self):
        ...
        result = self.relationship_manager.create_member_mollie_relationship(
            ...
            {"amount": 30.00, "interval": "1 month", "description": "End-to-end test subscription"},
        )
        ...
        webhook_data = {
            ...
            "status": "active",
            "customerId": mollie_customer_id,
            "payment": {"id": payment.id, "status": "paid", "metadata": {"member_id": self.test_member.name}},
        }
