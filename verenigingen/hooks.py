...
doc_events = {
    ...
    "Member": {
        ...
        "on_update": [
            ...
            "verenigingen.utils.cache_invalidation.on_document_update",  # Cache invalidation
            "verenigingen.utils.performance_cache.on_member_update",  # Performance cache invalidation
            "verenigingen.services.field_sync_service.sync_fields",  # Bidirectional field sync (image, email, name)
        ],
    },
...
permission_query_conditions = {
    ...
    "Chapter": "verenigingen.services.chapter.chapter_permission_service.ChapterPermissionService.get_permission_query_conditions",
...
has_permission = {
    ...
    "Chapter": "verenigingen.services.chapter.chapter_permission_service.ChapterPermissionService.has_chapter_permission",
