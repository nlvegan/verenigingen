...
class AccountMapper:
    ...
    def _create_account_enhanced(self, account_data):
        ...
        try:
            from verenigingen.utils.eboekhouden.eboekhouden_migration_enhancements import AccountCreator
    ...
    def _determine_account_type(self, account_data):
        ...
        try:
            from verenigingen.utils.eboekhouden.eboekhouden_smart_account_typing import (
