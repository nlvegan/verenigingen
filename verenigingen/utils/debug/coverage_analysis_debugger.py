...
def generate_solution_recommendations():
    ...
    if not has_start or not has_end:
        ...
        results.append(
            "1. bench --site dev.veganisme.net execute verenigingen.utils.debug.coverage_analysis_debugger.create_coverage_fields"
        )
        results.append(
            "2. bench --site dev.veganisme.net execute verenigingen.utils.debug.coverage_analysis_debugger.populate_coverage_dates"
        )
