...
class TransactionProcessor:
    ...
    def create_sales_invoice(self, invoice_data):
        ...
        try:
            ...
            from verenigingen.e_boekhouden.utils.invoice_helpers import create_sales_invoice_from_mutation
    ...
    def create_purchase_invoice(self, invoice_data):
        ...
        try:
            # Use invoice helpers for creation
            from verenigingen.e_boekhouden.utils.invoice_helpers import create_purchase_invoice_from_mutation
