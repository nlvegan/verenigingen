...
class TestRegion(EnhancedTestCase):
    ...
    def create_test_region(self, custom_name=None, custom_code=None, **kwargs):
        ...
        region_data["region_name"] = custom_name or f"Test Region {unique_suffix}"
        region_data["region_code"] = custom_code or f"T{unique_suffix[:3].upper()}"
    ...
    def create_test_member(self, custom_email=None, **kwargs):
        ...
        unique_suffix = self.get_unique_suffix()
        member_data["email"] = custom_email or f"test{unique_suffix}@coordinator.com"
        member_data["full_name"] = f"Test Coordinator {unique_suffix}"
        member_data["customer_name"] = f"Test Coordinator {unique_suffix}"
