...
def create_initial_dues_schedule(application, data):
    ...
    try:
        ...
        dues_schedule.minimum_amount = getattr(
            mt_doc, "minimum_contribution", mt_doc.amount * 0.3 if mt_doc.amount else 5.0
        )
        dues_schedule.suggested_amount = getattr(mt_doc, "suggested_contribution", mt_doc.amount or 15.0)
