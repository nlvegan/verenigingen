...
def execute_clean_import(confirm=False, from_date=None, to_date=None):
    ...
    from verenigingen.utils.eboekhouden.import_manager import EBoekhoudenImportManager
...
def setup_enhanced_infrastructure():
    ...
    try:
        # Setup Dutch UOMs
        from verenigingen.utils.eboekhouden.uom_manager import setup_dutch_uoms
