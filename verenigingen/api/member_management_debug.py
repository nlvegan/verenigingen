"""Debug and test endpoints for member management. Extracted from member_management.py to separate debug tooling from production API."""
...
@frappe.whitelist()
@development_only_api(operation_type=OperationType.MEMBER_DATA)
...
@frappe.whitelist()
@development_only_api(operation_type=OperationType.FINANCIAL)
def test_mt940_extraction(file_content, bank_account=None) -> OperationResult[Dict[str, Any]]:
    ...
    try:
        ...
        from verenigingen.api.member_management import extract_transaction_data_improved
...
def debug_mt940_import_detailed(
    ...
    try:
        ...
        from verenigingen.api.member_management import (
            create_bank_transaction_improved,
            extract_iban_from_mt940_content,
            extract_transaction_data_improved,
