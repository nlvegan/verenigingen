...
import frappe  
from frappe.utils import add_months, today, flt, add_days, get_datetime
...
class TestMollieSubscriptionIntegrationPhase4D(EnhancedTestCase):
    ...
    def _setup_authentic_membership_structure(self):
        ...
        print(f"✅ Membership structure: Type={self.membership_type.name}, Dues=€{self.dues_schedule.dues_rate}")
    ...
    def test_phase4d_authentic_webhook_payment_processing(self):
        ...
        webhook_payload = {
            "id": "sub_phase4d_webhook_test",
            "payment": {
                "id": "tr_phase4d_payment_test"
            }
        }
