"""Runner for member status transitions tests"""
...
def run_tests():
    ...
    try:
        # Import test module
        from verenigingen.tests.member.test_member_status_transitions_enhanced import TestMemberStatusTransitionsEnhanced
