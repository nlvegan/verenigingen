...
// Mock Chapter-specific utilities
global.window = {
    ...global.window,
    setup_chapter_form: jest.fn(),
    setup_chapter_buttons: jest.fn(),
    update_chapter_ui: jest.fn(),
    setup_board_grid: jest.fn(),
    display_chapter_join_requests: jest.fn(),
    validate_chapter_form: jest.fn(() => true),
    prepare_chapter_save: jest.fn(() => true),
    handle_chapter_after_save: jest.fn(),
    validate_postal_codes: jest.fn()
};
    ...
    describe('Form Lifecycle Events', () => {
        describe('Onload Handler', () => {
            ...
            it('should initialize chapter form functionality once', () => {
                ...
                expect(global.window.setup_chapter_form).toHaveBeenCalledWith(frm);
            ...
            it('should not reinitialize if already initialized', () => {
                ...
                expect(global.window.setup_chapter_form).not.toHaveBeenCalled();
            });
        });
        ...
        describe('Refresh Handler', () => {
            ...
            it('should setup chapter UI components', () => {
                ...
                expect(global.window.setup_chapter_buttons).toHaveBeenCalledWith(frm);
                expect(global.window.update_chapter_ui).toHaveBeenCalledWith(frm);
                expect(global.window.setup_board_grid).toHaveBeenCalledWith(frm);
                expect(global.window.display_chapter_join_requests).toHaveBeenCalledWith(frm);
            });
        });
        ...
        describe('Validate Handler', () => {
            ...
            it('should call chapter form validation', () => {
                ...
                expect(global.window.validate_chapter_form).toHaveBeenCalledWith(frm);
            });
            
            it('should return false when validation fails', () => {
                global.window.validate_chapter_form.mockReturnValue(false);
        ...
        describe('Before Save Handler', () => {
            ...
            it('should prepare chapter for saving', () => {
                ...
                expect(global.window.prepare_chapter_save).toHaveBeenCalledWith(frm);
            });
        });
        ...
        describe('After Save Handler', () => {
            ...
            it('should handle post-save operations', () => {
                ...
                expect(global.window.handle_chapter_after_save).toHaveBeenCalledWith(frm);
            });
        });
    });
    ...
    describe('Field Event Handlers', () => {
        describe('Postal Codes Handler', () => {
            ...
            it('should validate postal codes when changed', () => {
                ...
                expect(global.window.validate_postal_codes).toHaveBeenCalledWith(frm);
            });
