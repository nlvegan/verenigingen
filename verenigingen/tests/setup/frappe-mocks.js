...
function createFrappeMock() {
	return {
		...
		// Server-side framework methods
		provide: jest.fn(), // For server-side namespace creation
		query_reports: {}, // For server-side query report definitions

		// User roles (needed for controller permission checks)
		user_roles: ['System Manager', 'Verenigingen Administrator'],
...
function setupTestMocks() {
	...
	// Setup global helper functions expected by controllers
