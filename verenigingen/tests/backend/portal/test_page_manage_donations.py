...
class TestPageManageDonations(EnhancedTestCase):
    ...
    def _make_donation(self, *, status="One-time", amount=20.0, paid=0, recurring_freq=None, **extra):
        data = {
            "doctype": "Donation",
    ...
    def test_a_charge_donation_satisfies_every_pre_existing_gate(self):
        ...
        self.assertTrue(is_recurring_donation_active(charge.name), "the liveness check would pass")
