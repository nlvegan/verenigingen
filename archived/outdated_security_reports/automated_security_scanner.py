...
class APISecurityScanner:
    ...
    def _should_scan_file(self, file_path: Path) -> bool:
        ...
        exclude_patterns = ["test_", "__init__.py", ".backup", ".disabled", "__pycache__", ".pyc"]
    ...
    def _scan_file(self, file_path: Path):
        ...
        try:
            ...
            has_security_imports = any(
                decorator.replace("@", "") in content for decorator in self.security_decorators
            )
    ...
    def _classify_function_risk(
        self, function_name: str, function_code: str, file_path: str
    ) -> Tuple[SecurityRisk, OperationType, List[str]]:
    ...
    def _organize_results(self) -> Dict[str, List[APIFunction]]:
        ...
        organized = {"ULTRA_CRITICAL": [], "CRITICAL": [], "HIGH": [], "MEDIUM": [], "LOW": []}
    ...
    def generate_report(self) -> Dict:
        ...
        report = {
            "scan_summary": {
                ...
                "risk_breakdown": {risk: len(functions) for risk, functions in organized_results.items()},
            },
