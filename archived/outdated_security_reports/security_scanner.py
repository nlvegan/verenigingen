        ...
        for file_path in paths:
            ...
            for match in matches:
                ...
                has_permission_check = any(
                    "frappe.has_permission" in line or "frappe.throw" in line and "permission" in line.lower()
    ...
    def scan_test_context_leakage(self, test_paths: List[str]) -> List[Dict]:
        ...
        for file_path in test_paths:
            ...
            for i, match in enumerate(matches):
                ...
                has_reset = any(
                    "Administrator" in line and "frappe.set_user" in line for line in subsequent_lines
                )
