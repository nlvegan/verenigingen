...
def get_or_create_customer(mutation):
    ...
    # Import proper party extraction function (not SOAP!)
    ...
    if description and description.strip():
        ...
        # Try to extract a meaningful name from SEPA description using MT940-based extractor
        extractor = EBoekhoudenPartyExtractor()
        extracted_name = extractor._extract_party_name_from_description(full_description)
