...
class DutchTestDataGenerator {
  ...
  generateDonorData(options = {}) {
    ...
    const tussenv = useTussenvoegsel
      ? this.randomFromArray(this.tussenvoegsel)
      : null;
    ...
    if (includeDetails) {
      ...
      baseData.donationPreferences =
        this.generateDonationPreferences(donationType);
    }
  ...
  generateDonationPreferences(donationType) {
    ...
    if (donationType === "recurring") {
      preferences.recurringFrequency = this.randomFromArray([
        "Monthly",
        "Quarterly",
        "Yearly",
      ]);
      preferences.recurringAmount = this.randomFromArray([
