...
class DutchTestDataGenerator {
	...
	generatePostalCode(cityPrefix = null) {
		...
		const letters = String.fromCharCode(65 + this.randomInRange(0, 25), 65 + this.randomInRange(0, 25));
	...
	generateDonationPreferences(donationType) {
		...
		if (donationType === 'recurring') {
			...
			preferences.recurringAmount = this.randomFromArray([15.0, 25.0, 50.0, 100.0]);
		}
