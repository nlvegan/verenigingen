    ...
    it("should test Team Role Profile Assignment child table structure and behavior", () => {
      ...
      cy.execute_business_workflow(
        () => {
          cy.window().then((win) => {
            ...
            cy.log(
              "Team Role Profile Assignment child table structure validated",
            );
          });
          return true;
        },
      ...
      cy.execute_form_operation(() => {
        cy.window().then((win) => {
          ...
          cy.log(
            "Successfully added new row to Team Role Profile Assignment table",
          );
        });
        return true;
      }, "Add Child Table Row");
      ...
      cy.execute_business_workflow(
        () => {
          cy.window().then((win) => {
            ...
            const team_role_field = fields.find(
              (f) => f.fieldname === "team_role",
            );
            ...
            const role_profile_field = fields.find(
              (f) => f.fieldname === "role_profile",
            );
            ...
            const description_field = fields.find(
            ...
            cy.log(
              "Team Role Profile Assignment field configurations validated",
            );
          });
          return true;
        },
    ...
    it("should test Team Role Profile Assignment validation and error handling", () => {
      ...
      cy.execute_form_operation(() => {
        cy.window().then((win) => {
          ...
          cy.log(
            `Team child table has ${required_fields.length} required fields for validation`,
          );
  ...
  describe("Chapter Role Profile Mapping Child Table Tests", () => {
    beforeEach(() => {
      ...
      cy.fill_frappe_field(
        "introduction",
        "Testing chapter role profile child table",
      );
    ...
    it("should test Chapter Role Profile Mapping child table structure and behavior", () => {
      ...
      cy.execute_business_workflow(
        () => {
          cy.window().then((win) => {
            ...
            cy.log(
              "Chapter Role Profile Mapping child table structure validated",
            );
          });
          return true;
        },
      ...
      cy.execute_form_operation(() => {
        cy.window().then((win) => {
          ...
          cy.log(
            "Successfully added new row to Chapter Role Profile Mapping table",
          );
        });
        return true;
      ...
      cy.execute_business_workflow(
        () => {
          cy.window().then((win) => {
            ...
            const chapter_role_field = fields.find(
              (f) => f.fieldname === "chapter_role",
            );
            ...
            expect(description_field).to.exist;
            expect(description_field.fieldtype).to.equal("Small Text");
            expect(description_field.description).to.contain(
              "board role profile assignment",
            );

            cy.log(
              "Chapter Role Profile Mapping field configurations validated",
            );
          });
          return true;
        },
    ...
    it("should test Chapter Role Profile Mapping validation and error handling", () => {
      ...
      cy.execute_form_operation(() => {
        cy.window().then((win) => {
          ...
          expect(required_fields.length).to.be.greaterThan(0);
          cy.log(
            `Chapter child table has ${required_fields.length} required fields for validation`,
          );
