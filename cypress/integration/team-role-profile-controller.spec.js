...
describe('Team Role Profile System JavaScript Controller Tests', () => {
	...
	describe('User Experience and Interface Tests', () => {
		it('should test role profile section accessibility and usability', () => {
			...
			cy.get('[data-fieldname="default_role_profile"]').parent().should('contain', 'Default Role Profile');
		...
		it('should test responsive behavior and field interactions', () => {
			...
			cy.get('[data-fieldname="enable_role_specific_profiles"] input[type="checkbox"]').should('not.be.checked');

			cy.fill_frappe_field('enable_role_specific_profiles', true, {
				fieldtype: 'Check'
			});

			cy.get('[data-fieldname="enable_role_specific_profiles"] input[type="checkbox"]').should('be.checked');
