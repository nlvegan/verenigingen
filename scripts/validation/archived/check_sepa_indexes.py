...
def check_sepa_indexes():
    ...
    try:
        ...
        for row in query_plan:
            print(
                f"  Table: {row.get('table', 'N/A')}, Type: {row.get('type', 'N/A')}, "
...
if __name__ == "__main__":
    ...
    print(
        "bench --site dev.veganisme.net execute verenigingen.scripts.validation.check_sepa_indexes.check_sepa_indexes"
    )
