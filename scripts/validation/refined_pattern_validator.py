#!/usr/bin/env python3
"""
Refined Field Validator
Enhanced field validation system with reduced false positives focusing on:
1. Better DocType inference to avoid recursive reference errors
2. Configuration field handling
3. Context-aware validation
4. Recursive field reference detection
"""
...
class RefinedFieldValidator:
    """Refined field validator with smart pattern detection to eliminate false positives"""
    ...
    def _guess_doctype_from_context(self, content: str, node: ast.Attribute, obj_name: str) -> Optional[str]:
        ...
        # Enhanced: Look for variable name patterns that suggest DocType
        # Common naming patterns: member_doc, schedule, membership, volunteer_rec, etc.
...
def main():
    ...
    validator = RefinedFieldValidator(app_path)
