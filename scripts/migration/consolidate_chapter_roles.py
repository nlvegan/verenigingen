#!/usr/bin/env python3
"""
Chapter Role Consolidation Migration
====================================

Consolidates Verenigingen Chapter Manager role into Verenigingen Chapter Board Member role
and removes the redundant Chapter Manager role from the system.

Created: 2025-08-06
Purpose: Clean up redundant role after permission consolidation
"""

import frappe

def migrate_chapter_roles():
    ...
    for user_data in chapter_manager_users:
        ...
        try:
            ...
            has_board_member_role = any(
                role.role == "Verenigingen Chapter Board Member" 
    ...
    # 4. Remove the Chapter Manager role itself
    ...
    # 5. Clean up role profile references
